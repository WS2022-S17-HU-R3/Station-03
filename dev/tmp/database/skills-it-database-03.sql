...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2021. Júl 12. 10:29
...
CREATE TABLE `bookings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `accomodationId` bigint(20) UNSIGNED NOT NULL,
...
(1, '2021_07_12_071930_create_accomodations_table', 1),
(2, '2021_07_12_073352_create_bookings_table', 1);
...
ALTER TABLE `bookings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bookings_accomodationid_foreign` (`accomodationId`);
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_accomodationid_foreign` FOREIGN KEY (`accomodationId`) REFERENCES `accomodations` (`id`);
COMMIT;
